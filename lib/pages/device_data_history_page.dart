...
class DeviceDataHistoryPage extends StatefulWidget {
  final double flowValue;
  final double pressureValue;
  const DeviceDataHistoryPage({Key? key, required this.flowValue, required this.pressureValue}) : super(key: key);

  @override
  State<DeviceDataHistoryPage> createState() => _DeviceDataHistoryPageState();
}

class _DeviceDataHistoryPageState extends State<DeviceDataHistoryPage> {
  double chartIndex = 0;
